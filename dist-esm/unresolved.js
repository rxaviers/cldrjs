...
Cldr.prototype.get = function (path) {
  ...
  process.env.NODE_ENV !== "production" ? validateTypePath(path, "path") : void 0; // 1: use bundle as locale on item lookup for simplification purposes, because no other extended subtag is used anyway on bundle parent lookup.
